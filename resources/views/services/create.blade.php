...
<div class="container-fluid p-0 bg-slate-50" style="min-height: calc(100vh - 70px); margin-top: -24px;">
    <div class="p-4 p-md-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div>
                <h2 class="display-6 fw-extrabold text-slate-900 mb-1">Create Service</h2>
                <p class="text-slate-500 font-medium">Add a new professional service to your catalog</p>
            </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="name" class="form-control custom-input @error('name') is-invalid @enderror" 
                                   placeholder="e.g. Premium Health Consultation" value="{{ old('name') }}" required>
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="description" class="form-control custom-input @error('description') is-invalid @enderror" 
                                      rows="5" placeholder="Describe what this service includes..." required>{{ old('description') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="duration_minutes" class="form-control custom-input @error('duration_minutes') is-invalid @enderror" required>
                                <option value="15" {{ old('duration_minutes') == 15 ? 'selected' : '' }}>15 Mins</option>
                                <option value="30" {{ old('duration_minutes', 30) == 30 ? 'selected' : '' }}>30 Mins</option>
                                <option value="45" {{ old('duration_minutes') == 45 ? 'selected' : '' }}>45 Mins</option>
                        ...
                        <div class="mt-5">
                            <button type="submit" class="btn btn-modern-primary w-100 py-3 shadow-lg" data-loading-text="Saving...">
